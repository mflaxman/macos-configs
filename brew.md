...
With M1 (not x86):
```bash
$ brew reinstall ag aspell automake colordiff git-delta go htop ipython jq libsecp256k1 macvim openssl@3 pandoc postgresql pyenv ruby rbenv sqlite tcl-tk tor tree vim  --no-quarantine
```
Notes:
